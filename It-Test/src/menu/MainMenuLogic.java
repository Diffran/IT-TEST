...
public class MainMenuLogic {
    ...
    public static void mainMenuLogic(){
        do {
            ...
            }catch(InvalidMenuOptionException |NoClientException|NoFreeDeliveryDriverException|NumberFormatException|EmptyItemsListException|OrderIdNotFoundException|NullPointerException e){
